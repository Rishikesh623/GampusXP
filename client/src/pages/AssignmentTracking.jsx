...
const AssignmentTracking = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                await axios.patch(`${process.env.REACT_APP_BASE_URL}/assignment/edit`, assignmentForm, { withCredentials: true });
            } else {
                await axios.post(`${process.env.REACT_APP_BASE_URL}/assignment/add`, assignmentForm, { withCredentials: true });
            }
            fetchAssignments();
            toggleModal();
        } catch (error) {
    ...
    const handleRemove = async (assignment_id) => {
        try {
            await axios.delete(`${process.env.REACT_APP_BASE_URL}/assignment/remove/${assignment_id}`, { withCredentials: true });
    ...
    const markAsCompleted = async (assignment) => {
        try {
            ...
            await axios.patch(`${process.env.REACT_APP_BASE_URL}/assignment/edit`, updatedAssignment, { withCredentials: true });
            fetchAssignments();
        } catch (error) {
