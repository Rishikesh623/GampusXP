...
const RewardsChallenges = () => {
    ...
    const proposeChallengeHandler = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/challenges/propose`, newChallenge, { withCredentials: true });
    ...
    const getChallenges = async () => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/challenges/proposed`, {
    ...
    const handleInviteClick = async () => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/user/profile/${invitedUsersInput}`, { withCredentials: true });
            setNewChallenge((prev) => ({
                ...prev,
