...
const {createTimetable,addSlot,getTimetable,getTodaysTimeTable,editSlot,deleteTimetable, deleteSlot} = require('../controllers/timetableController');


const router = express.Router();

router.get('/',authUser,getTimetable);
router.get('/:day',authUser,getTodaysTimeTable);
